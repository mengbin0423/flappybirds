...
(function (ui) {
    var newRankUI = /** @class */ (function (_super) {
        ...
        newRankUI.uiView = { "type": "View", "props": { "width": 750, "height": 1334 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "width": 750, "skin": "res/bg.png", "height": 1334 }, "child": [{ "type": "Image", "props": { "y": 180, "x": 45, "width": 666, "skin": "res/rank_bg.png", "height": 842 }, "child": [{ "type": "Image", "props": { "y": 20, "x": 20, "skin": "res/list_bg.png" } }, { "type": "List", "props": { "y": 24, "x": 23, "width": 620, "var": "mlist", "repeatY": 5, "repeatX": 1, "height": 650 }, "child": [{ "type": "Box", "props": { "width": 620, "name": "render", "height": 130 }, "child": [{ "type": "Image", "props": { "y": 0, "x": 0, "var": "rk", "skin": "res/rank_other_rank_bg.png" }, "child": [{ "type": "Label", "props": { "y": 3, "x": 3, "width": 50, "text": "1", "overflow": "hidden", "name": "rk", "fontSize": 20, "color": "#FFFFFF", "anchorX": 0, "align": "center" } }] }, { "type": "Image", "props": { "y": 26, "x": 50, "width": 80, "name": "face", "height": 80, "anchorY": 0, "anchorX": 0 }, "child": [{ "type": "Image", "props": { "y": -1, "x": -1, "width": 82, "skin": "res/rank_other_bg.png", "height": 82, "anchorY": 0, "anchorX": 0 } }] }, { "type": "Label", "props": { "y": 34, "x": 159, "text": "测试用户", "overflow": "hidden", "name": "name", "fontSize": 22, "color": "#ffffff", "align": "left" } }, { "type": "Image", "props": { "y": 70, "x": 150, "skin": "res/rank_level_bg.png", "name": "ll" }, "child": [{ "type": "Label", "props": { "y": 17, "x": 70, "text": "灵犀一指", "name": "otherLevel", "fontSize": 22, "color": "#000000", "bold": true, "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }, { "type": "Label", "props": { "y": 60, "x": 590, "width": 120, "text": "999分", "strokeColor": "#18171A", "stroke": 4, "overflow": "hidden", "name": "mk", "fontSize": 30, "color": "#ffffff", "bold": true, "anchorY": 0.5, "anchorX": 1, "align": "right" } }, { "type": "Line", "props": { "y": 126, "x": 157, "toY": 0, "toX": 426.4516129032258, "lineWidth": 1, "lineColor": "#8FB7BF" } }] }] }, { "type": "Box", "props": { "y": 700, "x": 333, "width": 620, "var": "mSelf", "height": 130, "anchorX": 0.5 }, "child": [{ "type": "Image", "props": { "y": -10, "x": -20, "var": "rankbk", "skin": "res/rank_my_rank_bg.png" }, "child": [{ "type": "Label", "props": { "y": 14, "x": 20, "width": 30, "var": "mRank", "text": 99, "overflow": "hidden", "fontSize": 24, "color": "#ffffff", "anchorY": 0.5, "anchorX": 0, "align": "center" } }] }, { "type": "Image", "props": { "y": 24, "x": 50, "width": 80, "var": "myFace", "height": 80, "anchorY": 0, "anchorX": 0 }, "child": [{ "type": "Image", "props": { "y": -1, "x": -1, "width": 82, "skin": "res/rank_head_self.png", "height": 82, "anchorY": 0, "anchorX": 0 } }] }, { "type": "Label", "props": { "y": 34, "x": 160, "var": "mUser", "text": "测试用户", "overflow": "hidden", "fontSize": 22, "color": "#000000", "bold": true, "align": "left" } }, { "type": "Image", "props": { "y": 69, "x": 150, "skin": "res/rank_level_bg.png" } }, { "type": "Label", "props": { "y": 60, "x": 590, "width": 120, "var": "mMark", "text": "999分", "strokeColor": "#18171A", "stroke": 4, "overflow": "hidden", "fontSize": 30, "color": "#ffffff", "bold": true, "anchorY": 0.5, "anchorX": 1, "align": "right" } }, { "type": "Label", "props": { "y": 87, "x": 220, "var": "mLevel", "text": "灵犀一指", "fontSize": 22, "color": "#000000", "bold": true, "anchorY": 0.5, "anchorX": 0.5, "align": "center" } }] }] }, { "type": "Image", "props": { "y": 20, "x": 20, "var": "backBtn", "skin": "res/back_btn.png" } }, { "type": "Image", "props": { "y": 91, "x": 245, "var": "rankTitle", "skin": "res/rank_crowd.png" } }, { "type": "Image", "props": { "y": 1078, "x": 86, "var": "lastPage", "skin": "res/rank_last.png" } }, { "type": "Image", "props": { "y": 1078, "x": 418, "var": "nextPage", "skin": "res/rank_next.png" } }] }] };
        return newRankUI;
    }(View));
...
var newRank = /** @class */ (function (_super) {
            ...
            for (var i = 0; i < GameMain.app.mData.length; i++) {
                if (GameMain.app.mData[i]['openid'] == this.sOpenId) {
                    ...
                    if (this.mLevel == 1)
                        ...
                        this.mMark.text = Math.floor(GameMain.app.mData[i]['mark']) + "分";
                    this.mRank.text = GameMain.app.mData[i]['rank'];
                    have = true;
                    break;
                }
            ...
            for (var i = 0; i < GameMain.app.mGroups[groupid].length; i++) {
                if (GameMain.app.mGroups[groupid][i]['openid'] == this.sOpenId) {
                    ...
                    if (this.mLevel == 1)
                        ...
                        this.mMark.text = Math.floor(GameMain.app.mGroups[groupid][i]['mark']) + "分";
                    this.mRank.text = GameMain.app.mGroups[groupid][i]['rank'];
                    have = true;
                    break;
                }
    ...
    newRank.prototype.updateUser = function (cell, index) {
        ...
        if (cell.dataSource['map'] == 0)
            mark.text = Math.floor(cell.dataSource['mark']).toString() + "分";
        else if (cell.dataSource['map'] == 1) {
            var temp = Math.floor(cell.dataSource['map1']);
            if (temp > 100)
                temp = 100;
            mark.text = temp.toString() + "%";
        }
        else if (cell.dataSource['map'] == 2) {
            var temp = Math.floor(cell.dataSource['map2']);
            if (temp > 100)
                temp = 100;
            mark.text = temp.toString() + "%";
        }
        else if (cell.dataSource['map'] == 3) {
            var temp = Math.floor(cell.dataSource['map3']);
            if (temp > 100)
                temp = 100;
            mark.text = temp.toString() + "%";
        }
...
var GameMain = /** @class */ (function () {
    function GameMain() {
        this.mData = [];
        this.mLevel = [1050, 3050, 6050, 9050, 12050, 15050, 18050, 21050, 25050, 30050, 50050, 100050, 200050, 10000000];
        this.mLevelName = ["蠢萌菜鸟", "学飞雏鸟", "蹦跶家雀", "幼鸟展翅", "温顺鸽子", "矫健海鸥", "孔雀开屏", "优雅天鹅", "白头海雕", "北归大雁", "非洲鸵鸟", "凶猛秃鹰", "孤傲雄鹰", "浴火凤凰"];
        this.mGroups = {};
        this.mShareTicket = "";
        this.mOpenID = "";
        GameMain.app = this;
    ...
    GameMain.prototype.initData = function (users) {
        ...
        for (var i = 0; i < users.length; i++) {
            ...
            for (var m = 0; m < this.mLevel.length; m++) {
                if (this.mLevel[m] > Math.floor(obj['mark'])) {
                    level = m + 1;
                    break;
                }
            }
    ...
    GameMain.prototype.sendTencent = function (message) {
        ...
        for (var i = 0; i < GameMain.app.mData.length; i++) {
            if (GameMain.app.mData[i]['openid'] == user['openid']) {
                ...
                var level = this.mLevel.length;
                for (var m = 0; m < this.mLevel.length; m++) {
                    if (this.mLevel[m] > Math.floor(GameMain.app.mData[i]['mark'])) {
                        level = m + 1;
                        break;
                    }
                }
        ...
        if (message['show'] == 1) {
            ...
            if (row < 0)
                ...
                if (Number(message['level']) == 0)
                    next.mark.text = Math.floor(this.mData[row]['mark']) + "分";
